												...
												<tbody>
													...
													<tr class="cart_item">
														<td class="product-name">
															<?php echo htmlspecialchars( $value1["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <strong class="product-quantity">x <?php echo htmlspecialchars( $value1["nrqda"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> 
														</td>
