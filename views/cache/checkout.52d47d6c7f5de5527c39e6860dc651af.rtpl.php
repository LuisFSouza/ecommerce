									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
												...
												<tbody>
													...
													<tr class="cart_item">
														<td class="product-name">
															<?php echo htmlspecialchars( $value1["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <strong class="product-quantity">× <?php echo htmlspecialchars( $value1["nrqda"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> 
														</td>
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												...
												<label class="" for="billing_state"><img style="height:64px;" src="/resources/site/img/logo-pagseguro.png"></label>
											</p>

											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<input type="radio" checked id="method-paypal" name="payment-method" value="2" class="input-text" style="float:left; margin:30px;">
												<label class="" for="billing_state"><img style="height:64px;" src="/resources/site/img/logo-paypal.png"></label>
											</p>

											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<input type="radio" id="method-boleto" name="payment-method" value="3" class="input-text " style="float:left; margin-left:30px;margin-right: 30px; ">
												<label class="" for="billing_state">Boleto</label>
											</p>
											<div id="payment">
