...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>UFF STORE</strong><br>
                Rua X, N Y - Z<br>
                Cidade - Estado<br>
                Telefone: (xx) xxx-xxxx<br>
            ...
            <br>
            <b>Emitido em:</b> <?php echo formatDate($cart["dtregister"]); ?><br>
            <b>Pago em:</b> <?php echo formatDate($cart["dtregister"]); ?>
            </div>
            <!-- /.col -->
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    <td><?php echo htmlspecialchars( $value1["nrqda"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
